...
class ExpDataset(Dataset):
    def __init__(self, data_list, tokenizer, model_max_length, top_percent=1):
    ...
    def _get_model_input(self, text, tokens):
        ...
        # Build the highlight graph from highlighted spans: chain tokens within
        # each span and connect every token of the first span to every token of
        # the paired second span.
