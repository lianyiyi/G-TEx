    ...
    def forward(
        ...
        for i, (layer_module, past_key_value) in enumerate(zip(self.block, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                # Apply the GNN over the highlight graph at 75% encoder depth, mixing
                # token hidden states along the highlight-defined edges before the
                # remaining encoder layers.
                if i == int(self.n_layer / 0.75) - 1:
...
class T5ForConditionalGenerationGNN(T5ForConditionalGeneration):
    def __init__(self, config, num_beam, gnn):
        ...
        self.encoder = T5StackwithGNN(encoder_config, gnn)
